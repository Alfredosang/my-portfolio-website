...
const Contact = () => {
    return (
        <div className='footer flex items-center' id='contact'>
        ...
        <div className='container  mx-auto mb-10 ' >
            ...
            <div className='flex justify-center '>
                <form action='https://getform.io/f/c7f0dcef-a313-4d5c-9284-0e5472fb2e09' method='POST' className=' flex flex-col justify-center  '>
                    ...
                    <button className='w-[22rem] md:w-[50rem] bg-red-800 text-white m-1 px-5 py-4 rounded-md hover:bg-white/70 hover:text-black duration-200 shadow-black shadow-sm'>Send Message</button>
