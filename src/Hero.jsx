    ...
    return (
        <div>
            <div className='container flex flex-col pt-24 md:flex-row md:justify-center md:items-center  px-10 mx-auto'>
                ...
                <div>
                    <h2 className='text-white font-bold text-3xl md:text-5xl mt-3 mb-3  md:leading-[55px] hover:scale-105 duration-200'>Hello my name is  Alfred Osang, I'm a Frontend Developer. </h2>
